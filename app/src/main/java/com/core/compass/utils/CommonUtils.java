...
public final class CommonUtils {
    ...
    public static Drawable changeIconDrawableToGray(Context context, Drawable drawable, String newColor) {
        if (drawable != null) {
            drawable.mutate();
            drawable.setColorFilter(parserColor(newColor), PorterDuff.Mode.SRC_ATOP);
        }

        return drawable;
    }

    public static int parserColor(String hex){
        try {
